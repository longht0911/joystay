...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::group(['prefix' => 'homestay'], function () {
            Route::get('/', 'HomestayController@index')->name('homestay.index')->middleware('permission:danh-sach-homestay|full-quyen-quan-ly');
            Route::get('/create', 'HomestayController@create')->name('homestay.create')->middleware('permission:them-moi-homestay|full-quyen-quan-ly');
            Route::post('/create', 'HomestayController@store');

            Route::get('/update/{id}', 'HomestayController@edit')->name('homestay.update')->middleware('permission:chinh-sua-homestay|full-quyen-quan-ly');
            Route::post('/update/{id}', 'HomestayController@update');

            Route::get('/delete/{id}', 'HomestayController@delete')->name('homestay.delete')->middleware('permission:xoa-homestay|full-quyen-quan-ly');
        });
        ...
        Route::group(['prefix' => 'book-homestay'], function () {
            Route::get('/', 'BookHomeStayController@index')->name('book.homestay.index')->middleware('permission:quan-ly-dat-homestay|full-quyen-quan-ly');
            Route::get('/update/{status}/{id}', 'BookHomeStayController@updateStatus')->name('book.homestay.update.status')->middleware('permission:xoa-va-cap-nhat-trang-thai|full-quyen-quan-ly');
            Route::get('/delete/{id}', 'BookHomeStayController@delete')->name('book.homestay.delete')->middleware('permission:xoa-va-cap-nhat-trang-thai|full-quyen-quan-ly');
        });
...
Route::group(['namespace' => 'Page'], function () {
    ...
    Route::group(['middleware' => ['users']], function () {
        ...
        Route::get('danh-sach-homestay.html', 'AccountController@myhomestay')->name('my.homestay');
        ...
        Route::post('cancel/order/homestay/{status}/{id}', 'AccountController@updateStatus')->name('post.cancel.order.homestay');
    });

    Route::get('/', 'HomeController@index')->name('page.home');
    Route::get('/loi', 'HomeStayController@loi')->name('loi.loi');
    ...
    Route::get('/homestay.html', 'HomeStayController@index')->name('homestay');
    Route::get('book-homestay/{id}/{slug}.html', 'HomeStayController@bookHomeStay')->name('book.homestay');
    Route::post('book/homestay/{id}', 'HomeStayController@postBookHomeStay')->name('post.book.homestay');
    Route::get('/homestay/{id}/{slug}.html', 'HomeStayController@detail')->name('homestay.detail');
