...
class HomeStayRequest extends FormRequest
{
    ...
    public function rules(Request $request)
    {
        ...
        $rules = [
            //
            't_title' => 'required | max:191 | unique:homestays,t_title,' . $this->id,
            't_location_id' => ['required'],
            't_price' => ['required'],
            't_caption' => ['required'],
            't_utilities' => ['required'],
    ...
    public function messages()
    {
        return [
            ...
            't_price.required'      => 'Dữ liệu không được phép để trống',
            't_caption.required'      => 'Dữ liệu không được phép để trống',
            't_utilities.required'      => 'Dữ liệu không được phép để trống',
