                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Tổng số homestay</span>
                                    <span class="info-box-number">{{ number_format($homestay) }}</span>
                                </div>
                                <!-- /.info-box-content -->
                            </div>
                            <!-- /.info-box -->
                        ...
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Homestay đã đặt</span>
                                    <span class="info-box-number">{{ number_format($bookhomestay) }}</span>
                                </div>
                                <!-- /.info-box-content -->
                            </div>
                            <!-- /.info-box -->
                        ...
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Tổng số thành viên trong hệ thống</span>
...
<td style="width: 33.3333%; text-align: center; height: 17px;"><strong><em>Mã homestay</em></strong></td>
<td style="width: 33.3333%; text-align: center; height: 17px;"><strong><em>Tên homestay</em></strong></td>
<td style="width: 33.3333%; text-align: center; height: 17px;"><strong><em>Lượt đăng ký</em></strong></td>
</tr>
               @foreach($homestays as $homestay)

<tr style="height: 17px;">
<td style="width: 33.3333%; text-align: center; height: 17px;">{{$homestay->id}}</td>
<td style="width: 33.3333%; text-align: center; height: 17px;">{{$homestay->t_title}}</td>
<td style="width: 33.3333%; text-align: center; height: 17px;">{{$homestay->t_follow}}</td>
</tr>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Trạng thái các homestay du lịch'
            },
        ...
        Highcharts.chart('container2', {
            ...
            title: {
                text: 'Thống kê lượng phòng đặt homestay trong tháng'
            },
            subtitle: {
