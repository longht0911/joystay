    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endif
                @if(Auth::user()->can(['full-quyen-quan-ly', 'danh-sach-homestay']))
                <li class="nav-item">
                    <a href="{{ route('homestay.index') }}" class="nav-link {{ isset($homestay_active) ? $homestay_active : '' }}">
                ...
                @if(Auth::user()->can(['full-quyen-quan-ly', 'quan-ly-dat-homestay']))
                    <li class="nav-item">
                        <a href="{{ route('book.homestay.index') }}" class="nav-link {{ isset($book_homestay_active) ? $book_homestay_active : '' }}">
                            <i class="nav-icon fas fa-cart-plus" aria-hidden="true"></i>
                            <p>Danh sách đặt homestay</p>
                        </a>
                    </li>
                @endif
