                        ...
                        <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
                            <div class="services services-1 color-1 d-block img" style="background-image: url({{ asset('page/images/services-1.jpg') }});">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>Hoạt động dã ngoại trong quá trình du lịch</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
                            <div class="services services-1 color-2 d-block img" style="background-image: url({{ asset('page/images/services-2.jpg') }});">
                                ...
                                <div class="media-body">
                                    <h3 class="heading mb-3">Sắp xếp nghỉ dưỡng</h3>
                                    <p>Chúng tôi sẽ giúp bạn sắp xếp nơi nghỉ dưỡng một cách thoải mái nhất, luôn luôn có các homestay để bạn có nhiều sự lựa chọn</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
                            <div class="services services-1 color-3 d-block img" style="background-image: url({{ asset('page/images/services-3.jpg') }});">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>Xách balo lên vào đi với chúng tôi, bạn sẽ có được những trải nghiệm tuyệt vời với dịch vụ của chúng tôi!</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
                            <div class="services services-1 color-4 d-block img" style="background-image: url({{ asset('page/images/services-4.jpg') }});">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>Các bạn hãy tìm đến với JoyStay để được đi đến bất cứ nơi nào trên đất nước Việt Nam. Dành cho người có niềm đam mê bất tận với du lịch!</p>
                                </div>
                            </div>
                        </div>
                    </div>
