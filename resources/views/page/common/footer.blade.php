        ...
        <div class="row mb-5">
            <div class="col-md pt-5">
                <div class="ftco-footer-widget pt-md-5 mb-4">
                    ...
                    <p>Website JoyStay cho phép đặt các homestay du lịch trên cả nước.</p>
                    <ul class="ftco-footer-social list-unstyled float-md-left float-lft">
                        <li class="ftco-animate"><a href="https://web.facebook.com/long.ht.169/"><span class="fa fa-facebook"></span></a></li>
            ...
            <div class="col-md pt-5 border-left">
                <div class="ftco-footer-widget pt-md-5 mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon fa fa-map-marker"></span><span class="text"> Hà Đông, Hà Nội</span></li>
                            <li><a href="#"><span class="icon fa fa-phone"></span><span class="text">0123456789</span></a></li>
                            <li><a href="#"><span class="icon fa fa-paper-plane"></span><span class="text">joystay@gmail.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
