<form action="{{ route('homestay') }}" class="search-property-1">
        ...
        <div class="col-md d-flex">
            <div class="form-group p-4 border-0">
                ...
                <div class="form-field">
                    ...
                    <input type="text" name="key_homestay" value="{{ Request::get('key_homestay') }}" class="form-control" placeholder="Tìm kiếm">
                </div>
            </div>
        </div>
        <div class="col-md d-flex">
