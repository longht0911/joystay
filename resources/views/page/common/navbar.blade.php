<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="{{ route('page.home') }}">JoyStay<span></span></a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item {{ request()->is('homestay.html') || request()->is('homestay/*') ? 'active' : '' }}"><a href="{{ route('homestay') }}" class="nav-link">Homestay</a></li>
                ...
                @if (Auth::guard('users')->check())
                    ...
                    <li class="nav-item {{ request()->is('thong-tin-tai-khoan.html') || request()->is('thay-doi-mat-khau.html') || request()->is('danh-sach-homestay.html') ? 'active' : '' }}"><a href="{{ route('info.account') }}" class="nav-link" title="{{ $user->name }}">Xin chào : {{ the_excerpt($user->name, 15) }}</a></li>
